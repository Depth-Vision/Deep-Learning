...
if __name__ == "__main__":
    Train = Trainer(lr=0.0001,batch_size=8,num_epoch=10,img_w=224,img_h=224,data_path="Image_Classification/Data_RM",model_path="Image_Classification/VGG_Net/model",device="GPU")
    Train.train()
